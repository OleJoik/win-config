...
-- Here we let the LSP prioritize null-ls formatters. 
-- Why? Normally when we install a separate formatter or 
-- linter in null-ls we want to use just them.
-- if you don't prioritize any, neovim will ask you 
-- every time you format which one you want to use.
